...
func SpeakAsk(prompt string) (password string, err error) {
	return SpeakFAsk(os.Stdout, prompt)
}
...
func SpeakFAsk(wr io.Writer, prompt string) (password string, err error) {
	if wr != nil && prompt != "" {
